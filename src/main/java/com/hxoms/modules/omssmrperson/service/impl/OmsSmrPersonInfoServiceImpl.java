...
public class OmsSmrPersonInfoServiceImpl extends ServiceImpl<OmsSmrPersonInfoMapper,OmsSmrPersonInfo> implements OmsSmrPersonInfoService {
    ...
    @Override
    public boolean exportSmrPersonInfo(List<OmsSmrPersonInfo> list, HttpServletResponse response) {
    ...
    public static List<Map<String, Object>> readExcel(String filePath) {
        ...
        for (int numSheet = 0; numSheet < workbook.getNumberOfSheets(); numSheet++) {
            ...
            for (int rowNum = 3; rowNum <= hssfSheet.getLastRowNum(); rowNum++) {
                ...
                map.put("secretRelatedLevel",cell.getStringCellValue());
                //人员类型
     ...
     * @return int
     */
    private int getIsMatching(String workUnit,String idCardNumber){
