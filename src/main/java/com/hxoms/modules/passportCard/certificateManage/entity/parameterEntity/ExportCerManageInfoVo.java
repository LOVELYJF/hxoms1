...
public class ExportCerManageInfoVo {
    ...
    private String saveStatusName;//保管状态
    private String personnelStatus;//人员状态 目前没有值
    ...
    private String csdd;//出生地点
    private String exceprionMessqge;//存疑信息
