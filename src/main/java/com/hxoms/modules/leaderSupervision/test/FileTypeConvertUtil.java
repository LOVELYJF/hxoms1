...
//        String pdfFile = "d:/pdf/wjf22.pdf";
...
//
        sb.append("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                .append("<div style=\"width:771px;font-size:40px;text-align:center;\">中共海南省委组织部来文处理单</div>\n" +
                        ...
                        "                    <td colspan=\"5\" style=\"font-size:20px;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;近日，我处收到关于办理张新文同志赴安道尔共和国备案手续的请示，张新文同志于2020年07月30日至2020年08月07日赴安道尔共和国开展$出访任务$，在外停留4天。经征求省纪委意见，省纪委对张新文出国（境）持异议，不予回复意见。建议不予办理张新文同志出国（境）备案手续。\n" +
                        "\n" +
