...
//import com.hxoms.modules.leaderSupervision.test.Base64ImgReplacedElementFactory;
...
public class FileTypeConvertUtil {
    ...
    public static void html2pdf(String htmlStr, String pdfFile) throws Exception {
        // step 1
...
//        htmlStr= htmlStr.replace("closingtags=\"\"", "/");
        String url = new File(htmlStr).toURI().toURL().toString();
...
//        renderer.setDocument(url);
        ...
        if("linux".equals(getCurrentOperatingSystem())){
            ...
            fontResolver.addFont("src/lib/simsun.ttc", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
        }
        renderer.layout();
...
//        String htmlFile = "d:\\pdf\\index57583.html";
        ...
        sb.append("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                .append("<div style=\"width:711px;font-size:40px;text-align:center;\">中共海南省委组织部来文处理单</div>\n" +
//                .append("<title id=\"footer\">中共海南省委组织部来文处理单</title>\n" +
                        "        <table width=\"711\">\n" +
                        "            <tbody>\n" +
        ...
        try {
            FileTypeConvertUtil.html2pdf(sb.toString(), null);
